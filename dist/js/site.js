 ...
 * Build: http://modernizr.com/download/#-csstransforms3d-inputtypes-touch-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes
 */
		...
		methods = {
			...
			_addNextPrev: function(){
				...
				$nav = $("<nav class='"+ navClass +"'>" +
					"<a href='#prev' class='prev' aria-hidden='true' title='Previous'></a>" +
					"<a href='#next' class='next' aria-hidden='true' title='Next'></a>" +
					"</nav>");
